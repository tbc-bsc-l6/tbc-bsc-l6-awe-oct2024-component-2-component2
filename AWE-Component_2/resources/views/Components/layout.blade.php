...
<div class="bg-white">
  <header class="absolute inset-x-0 top-0 z-50">
    <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
      ...
      <div class="hidden lg:flex lg:gap-x-12">
        ...
        <a href="/about" class="text-md/6 font-semibold text-gray-900">About</a>
        <a href="/contact" class="text-md/6 font-semibold text-gray-900">Contact</a>
      </div>
      <div class="hidden lg:flex lg:flex-1 lg:justify-end">
        <a href="#" class="text-md/6 font-semibold text-gray-900">Log in <span aria-hidden="true">&rarr;</span></a>
      </div>
    </nav>
  ...
  <div class="relative isolate px-6 pt-14 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        ...
        <p class="mt-8 text-pretty text-lg font-medium text-gray-500 sm:text-xl/8">Enjoy a wide selection of top recommendations, just for you.<br>Let’s get started! It only takes a minute to join.</p>{{$heading}}
