	...
	<html lang="en">
		<head>
			...
			<title>Food Circles :: Admin Panel</title>
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown">
							<a class="nav-link p-0 pr-3" data-toggle="dropdown" href="#">
								<img src="<?php echo e(asset('images/logo12.png')); ?>" class='img-circle elevation-0' width="40" height="40" alt="">
							</a>
	...
	<strong>Copyright &copy; 2023-<script>document.write(new Date().getFullYear())</script> Food Circles . All Rights Reserved</strong>
				</footer>
	...
	</html><?php /**PATH F:\LaravelProject\laravel_1st\resources\views/admin/layouts/app.blade.php ENDPATH**/ ?>